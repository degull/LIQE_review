...
# SRCC for Quality + Scene
combined_quality_scene_scores = [(q + s) / 2 for q, s in zip(predicted_quality_scores, predicted_scene_scores)]
srcc_quality_scene = scipy.stats.spearmanr(combined_quality_scene_scores, mos_scores)[0]

# SRCC for Quality + Distortion
combined_quality_distortion_scores = [(q + d) / 2 for q, d in zip(predicted_quality_scores, predicted_distortion_scores)]
