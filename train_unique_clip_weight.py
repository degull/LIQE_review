if __name__ == '__main__':
    ...
    for session in range(0,10):
        ...
        live_train_csv = os.path.join('C:/Users/IIPL02/Desktop/LIQE/LIQE/IQA_Database/databaserelease2/splits2/1', 'live_train_clip.txt')
        live_val_csv = os.path.join('C:/Users/IIPL02/Desktop/LIQE/LIQE/IQA_Database/databaserelease2/splits2/1', 'live_val_clip.txt')
        live_test_csv = os.path.join('C:/Users/IIPL02/Desktop/LIQE/LIQE/IQA_Database/databaserelease2/splits2/1', 'live_test_clip.txt')

        csiq_train_csv = os.path.join('C:/Users/IIPL02/Desktop/LIQE/LIQE/IQA_Database/CSIQ/splits2/1', 'csiq_train_clip.txt')
        csiq_val_csv = os.path.join('C:/Users/IIPL02/Desktop/LIQE/LIQE/IQA_Database/CSIQ/splits2/1', 'csiq_val_clip.txt')
        csiq_test_csv = os.path.join('C:/Users/IIPL02/Desktop/LIQE/LIQE/IQA_Database/CSIQ/splits2/1', 'csiq_test_clip.txt')


        bid_train_csv = os.path.join('C:/Users/IIPL02/Desktop/LIQE/LIQE/IQA_Database/BID/splits2/1', 'bid_train_clip.txt')
        bid_val_csv = os.path.join('C:/Users/IIPL02/Desktop/LIQE/LIQE/IQA_Database/BID/splits2/1', 'bid_val_clip.txt')
        bid_test_csv = os.path.join('C:/Users/IIPL02/Desktop/LIQE/LIQE/IQA_Database/BID/splits2/1', 'bid_test_clip.txt')


        clive_train_csv = os.path.join('C:/Users/IIPL02/Desktop/LIQE/LIQE/IQA_Database/ChallengeDB_release/splits2/1', 'clive_train_clip.txt')
        clive_val_csv = os.path.join('C:/Users/IIPL02/Desktop/LIQE/LIQE/IQA_Database/ChallengeDB_release/splits2/1', 'clive_val_clip.txt')
        clive_test_csv = os.path.join('C:/Users/IIPL02/Desktop/LIQE/LIQE/IQA_Database/ChallengeDB_release/splits2/1', 'clive_test_clip.txt')


        koniq10k_train_csv = os.path.join('C:/Users/IIPL02/Desktop/LIQE/LIQE/IQA_Database/koniq-10k/splits2/1', 'koniq10k_train_clip.txt')
        koniq10k_val_csv = os.path.join('C:/Users/IIPL02/Desktop/LIQE/LIQE/IQA_Database/koniq-10k/splits2/1', 'koniq10k_val_clip.txt')
        koniq10k_test_csv = os.path.join('C:/Users/IIPL02/Desktop/LIQE/LIQE/IQA_Database/koniq-10k/splits2/1', 'koniq10k_test_clip.txt')

        kadid10k_train_csv = os.path.join('C:/Users/IIPL02/Desktop/LIQE/LIQE/IQA_Database/kadid10k/splits2/1', 'kadid10k_train_clip.txt')
        kadid10k_val_csv = os.path.join('C:/Users/IIPL02/Desktop/LIQE/LIQE/IQA_Database/kadid10k/splits2/1', 'kadid10k_val_clip.txt')
        kadid10k_test_csv = os.path.join('C:/Users/IIPL02/Desktop/LIQE/LIQE/IQA_Database/kadid10k/splits2/1', 'kadid10k_test_clip.txt')
