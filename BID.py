...
if __name__ == '__main__':
    ...
    # 모델 학습
    trained_model = train_model(model, text_features, dataloader, criterion, optimizer, device, num_epochs=45)

    # 학습된 모델 저장
    torch.save(trained_model.state_dict(), 'C:/Users/IIPL02/Desktop/LIQE/LIQE/pt/BID_fin.pt')
